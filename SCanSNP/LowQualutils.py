...
def LowQualScore(DropToDBLDict,Counts,DBLSpecificSingularLociDict,vcf, GenotypesDF,SingularLociScoreDF):
	...
	for Doublet in ExtractOrderedDoublets(vcf):
		...
		#Homoz Loci
		Counts__HOMOZ,GenotypesDF_sliced_HOMOZ =Counts.slice(Genotypes=GenotypesDF, lociList= DBLSpecificSingularLociDict["Homoz"][Doublet], barcodeList=DropToDBLDict[Doublet])
		#Heteroz Loci Ref
		Counts_RefHet,GenotypesDF_sliced_RefHet =Counts.slice(Genotypes=GenotypesDF, lociList= DBLSpecificSingularLociDict["HeteroRef"][Doublet], barcodeList=DropToDBLDict[Doublet])
		#Heteroz Loci Alt
		Counts_AltHet,GenotypesDF_sliced_AltHet =Counts.slice(Genotypes=GenotypesDF, lociList= DBLSpecificSingularLociDict["HeteroAlt"][Doublet], barcodeList=DropToDBLDict[Doublet])
